...
include_once ('../widgets/login_view.php');}
 ...
 <button type="submit" class="btn btn-default" onclick="testingf('../scripts/testing.php','#uid','#pwd');return false;">
						Testing</button>
 </div>
 -->
			</div>
...
$result=mysqli_query($connect, $sql);
        ...
        $views=$value['views'];
						...
						?>
				<div class="panel-body">
			<!--		<p>For "Network Security" Subject's Homework. Internal circulation only.</p>
